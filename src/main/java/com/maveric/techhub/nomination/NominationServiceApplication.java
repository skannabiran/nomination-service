package com.maveric.techhub.nomination;

import com.maveric.techhub.nomination.config.AppConstants;
import com.maveric.techhub.nomination.config.DefaultProfileUtil;
...
public class NominationServiceApplication {
	private static final Logger log = LoggerFactory.getLogger(NominationServiceApplication.class);
	private final Environment env;

	public NominationServiceApplication(Environment env) {
		this.env = env;
	}
	...
	public static void main(String[] args) throws UnknownHostException {
		SpringApplication app = new SpringApplication(NominationServiceApplication.class);
